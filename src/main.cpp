...
int main() {
  ...
  sf::Texture catTex, jumpTex, keyTex, bgTex, menuBgTex, obj1Tex, obj2Tex,
      spikeTex, doorTex;
  ...
  menuBgSprite.setScale(screenW / menuBgSprite.getLocalBounds().width,
                        screenH / menuBgSprite.getLocalBounds().height);
    ...
    while (window.pollEvent(event)) {
      ...
      if (event.type == sf::Event::KeyReleased) {
        ...
        if (event.key.code == sf::Keyboard::Return) {
          ...
          if (choice == 0)
            runLevel1(window, catTex, jumpTex, keyTex, bgTex, obj1Tex, obj2Tex,
                      spikeTex, doorTex);
          if (choice == 1)
            runLevel2(window, catTex, jumpTex, keyTex, bgTex, obj1Tex, obj2Tex,
                      spikeTex, doorTex);
          if (choice == 2)
            runLevel3(window, catTex, jumpTex, keyTex, bgTex, obj1Tex, obj2Tex,
                      spikeTex, doorTex);
