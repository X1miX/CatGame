...
int main()
{
    ...
    if (!jumpTexture.loadFromFile("../images/jump.png"))
        return -1;
    ...
    while (win.isOpen())
    {
        ...
        updateAnimation(cat, catTexture, jumpTexture, catRect, jumpRect, jumpClock, fallClock, startedFalling, isMoving, animClock, animSpeed, currentFrame, totalFrames, frameW, padding, onGround, velocityY);
